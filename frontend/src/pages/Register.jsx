    ...
    <PageWrapper className="flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join CloudyAI today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl py-3 font-semibold transition-all shadow-lg hover:shadow-indigo-500/25 mt-2">
            Create Account
          </button>
        </form>
